...
func (m *Repository) PostShowLogin(w http.ResponseWriter, r *http.Request) {
	_ = m.App.Session.RenewToken(r.Context()) //Renew tokens for security issues
...
// AdminDashboard shows the admin dashboard page
func (m *Repository) AdminDashboard(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "admin-dashboard.page.tmpl", &models.TemplateData{})
}

// AdminAllReservations shows all reservatons in admin tool
...
func (m *Repository) AdminPostShowReservation(w http.ResponseWriter, r *http.Request) {
	...
	if year == "" {
		...
		http.Redirect(w, r, fmt.Sprintf("/admin/reservations-calendar?year=%s&m=%s", year, month), http.StatusSeeOther)
	}
...
func (m *Repository) AdminReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	for _, x := range rooms {
		...
		// Initialize both maps with 0 on each day of the month
...
func (m *Repository) AdminPostReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	for _, x := range rooms {
		...
		// that does not exists in our posted data, and if the restriction id > 0, then it is a block we need
		// to remove
