...
import (
	...
	"github.com/EzeRomanelli/bookings/internal/forms"
...
// PostAvailability posts to the /search-availability endpoint
...
// AvailabilityJSON handles request for availability and end JSON response
